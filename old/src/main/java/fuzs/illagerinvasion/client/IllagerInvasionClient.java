...
@Mod.EventBusSubscriber(modid = IllagerInvasion.MOD_ID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class IllagerInvasionClient implements ClientModConstructor {
    ...
    public void onRegisterParticleProviders(ParticleProvidersContext context) {
        ...
        //TODO
        context.registerParticleFactory(ModRegistry.NECROMANCER_BUFF_PARTICLE_TYPE.get(), FlameParticle.Provider::new);
    }
