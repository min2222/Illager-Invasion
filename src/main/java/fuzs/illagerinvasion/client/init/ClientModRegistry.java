...
public class ClientModRegistry {
    static final ModelLayerRegistry FACTORY = ClientFactories.INSTANCE.modelLayerRegistration(IllagerInvasion.MOD_ID);
    ...
    public static LayerDefinition createIllagerBodyLayer(CubeDeformation cubeDeformation) {
        ...
        partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 20).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, cubeDeformation).texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));
